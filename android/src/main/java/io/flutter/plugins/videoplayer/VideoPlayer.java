...
final class VideoPlayer {
  ...
  VideoPlayer(
    ...
    data.forEach((key, value) -> System.out.println("Data -> " + key + ": " + value));
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.R) {
      ...
      Objects.requireNonNull(DisplayManagerCompat.getInstance(context.getApplicationContext()).getDisplay(Display.DEFAULT_DISPLAY)).getSize(size);
    }
    */
    muxStats.setScreenSize(size.x, size.y);
//    muxStats.setPlayerView(exoPlayer);
